...
export const chaptersData: Chapter[] = [
  {
    ...
    subtitle: "O Primeiro Ano",
    description:
      "Aqueles primeiros momentos mágicos, cheios de descobertas e nervosismo gostoso...",
    unlocked: true,
    tone: "discovery",
    memories: [
      {
        id: 1,
        caption: "Uma bala no Salles",
        location: "Salles Jardins, Valle.",
        date: "12 de junho",
      ...
      },
      {
        id: 3,
        caption: "Barzin",
        location: "Bar na praça do estrela",
      ...
      {
        id: 7,
        caption: "O Natal Antes da Viagem",
        date: "25 de julho",
  ...
  {
    id: 2,
    title: "Cumplicidade e Aventuras",
    subtitle: "O Segundo Ano",
    description:
      "Quando descobrimos que éramos mais do que um casal... éramos uma equipe.",
    unlocked: false,
    tone: "adventure",
    memories: [
      {
  ...
  {
    id: 3,
    title: "Companheirismo e Amor Maduro",
    subtitle: "O Terceiro Ano",
    description:
      "Quando o amor jovem se transformou em algo profundo, sólido e eterno.",
    unlocked: false,
    tone: "maturity",
    memories: [
      {
  ...
  {
    id: 4,
    title: "O Futuro é Nosso",
    subtitle: "Capítulo em Branco",
    description:
      "Porque as melhores histórias são aquelas que ainda estamos por escrever...",
    unlocked: false,
    tone: "future",
    memories: [],
  },
